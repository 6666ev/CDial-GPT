...
def main():
    ...
    parser.add_argument("--datapath", type=str, default="data/toy_data.json", help="Path of the dataset.")
    parser.add_argument("--out_path", type=str, default="toy_result.txt", help="Path of response generated.")
    parser.add_argument("--model_checkpoint", type=str, default="runs/Jan12_18-11-04_klab-SYS-7049GP-TRT", help="Path, url or short name of the model")
